...
@implementation OWCoreTextGlyphRun
{
	CTRunRef _run;
	...
	__unsafe_unretained OWCoreTextLayoutLine *_line;	// retain cycle, since these objects are retained by the _line
	__unsafe_unretained NSDictionary *attributes;
    NSArray *stringIndices;
	
	OWTextAttachment *_attachment;
...
{
	return [NSString stringWithFormat:@"<%@ glyphs=%li %@>", [self class], (long)[self numberOfGlyphs], NSStringFromCGRect(_frame)];
}
