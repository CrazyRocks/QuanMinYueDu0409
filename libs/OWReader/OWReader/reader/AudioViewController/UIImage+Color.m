...
+ (UIImage *)imageWithMusicGradient:(UIColor*)startColor withEndColor:(UIColor*)endColor{
    ...
    NSArray *colors = [NSArray arrayWithObjects:[UIColor whiteColor], [UIColor whiteColor], nil];
...
//    CGGradientRef _gradientRef = CGGradientCreateWithColorComponents(rgb, colorArray, NULL, sizeof(colors) / (sizeof(colors[0]) * 4));
