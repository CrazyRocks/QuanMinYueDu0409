...
@interface LYSinaWeibo (SinaWeiboRequest)
- (void)requestDidFinish:(LYSinaWeiboRequest *)request;
- (void)requestDidFailWithInvalidToken:(NSError *)error;
@end

@interface LYSinaWeiboRequest (Private)
...
@implementation LYSinaWeiboRequest
...
{
    LYSinaWeiboRequest *request = [[LYSinaWeiboRequest alloc] init];
                                    ...
                                    delegate:(id<LYSinaWeiboRequestDelegate>)delegate
{
    ...
    return [LYSinaWeiboRequest requestWithURL:url
